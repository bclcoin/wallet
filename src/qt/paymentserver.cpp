...
const QString BITCOIN_IPC_PREFIX("bclcoin:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click bclcoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start bclcoin: click-to-pay handler");
    else
...
{
    // clicking on bclcoin: URLs creates FileOpen events on the Mac:
